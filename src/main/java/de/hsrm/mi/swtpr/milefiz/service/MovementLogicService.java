...
public class MovementLogicService {
    ...
    public FigureMoveResult moveFigure(Game game, FigureMoveRequest request) {
        ...
        // Validierung wurde hier entfernt weil mit der neuen Logik bis vor die Barriere
        // laufen dürfen
        /*
        ...
        if (actualDestField != game.getBoard().get(figure.getGridI(), figure.getGridJ())
                && actualDestField.getFigures().size() >= 2) {
