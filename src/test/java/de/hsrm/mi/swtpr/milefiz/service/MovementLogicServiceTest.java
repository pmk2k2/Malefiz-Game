...
class MovementLogicServiceTest {
    ...
    // { new Field(0,0, CellType.PATH), new Field(1,0, CellType.PATH), new
    // Field(2,0, CellType.PATH) },
    // { new Field(0,1, CellType.BLOCKED), new Field(1,1, CellType.PATH), new
    // Field(2,1, CellType.PATH) },
    // { new Field(0,2, CellType.PATH), new Field(1,2, CellType.PATH), new
    // Field(2,2, CellType.PATH) },
    // { new Field(0,3, CellType.PATH), new Field(1,3, CellType.PATH), new
    // Field(2,3, CellType.GOAL) }
    // };
    ...
    // /**
    // * #48 Bewegung durch Würfel:
    // * Testet, dass eine Bewegung abgelehnt wird, wenn zuvor nicht gewürfelt
    // wurde.
    // */
    // @Test
    ...
    // assertEquals(0, game.getCurrentMovementAmount(), "Würfel muss nach Zug auf 0
    // gesetzt werden");
    // }

    // /**
    // * #48 Bewegung durch Würfel:
    // * Testet, dass Bewegung fehlschlägt, wenn die Distanz größer als der
    // Würfelwurf ist.
    // */
    // @Test
    ...
    // assertFalse(result.success);
    // assertTrue(result.message.contains("genau 1 Felder"), "Sollte fehlschlagen,
    // da Distanz nicht passt");
    // }
    ...
    // FigureMoveResult result = movement.moveFigure(game, request(-1, 0));
    // assertFalse(result.success);
    // assertEquals("Bewegung außerhalb Spielfelds ist nicht erlaubt",
    // result.message);
    // }
