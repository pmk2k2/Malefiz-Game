    ...
    <div class="modal-content">
      ...
      <div class="board-options">
        <div
          ...
          :key="preset"
          class="board-option"
          :class="{ selected: selectedBoard === preset }"
        ...
        <div
          class="board-option custom-option"
          :class="{ selected: selectedBoard === 'custom' }"
          @click="openEditor"
        >
          <div class="option-icon">✏️</div>
      ...
      <div class="button-group">
        <button class="btn import-btn" @click="importMap">Import</button>
